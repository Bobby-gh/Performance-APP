  <aside class="main-sidebar sidebar-dark-primary elevation-4 bg-navy">
    <div class="dropdown">
   	<a href="./" class="brand-">
        ...
        <h1 class="text-center p-0 m- bg-white"><b>ADMIN</b></h1>
        <?php elseif($_SESSION['login_type'] == 1): ?>
        <h1 class="text-center p-0 m-0 bg-white"><b>MANAGER</b></h1>
         <?php else: ?>
        <h1 class="text-center p-0 m-0 bg-white"><b>EMPLOYEE</b></h1>
        <?php endif; ?>
