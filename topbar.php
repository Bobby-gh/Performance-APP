<!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-primary navbar-dark bg-blue">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
    ...
    <?php endif; ?>
      <li>
        <a class="nav-link text-white"  href="./" role="button"> <large><b>Employee Management Dashboard</b></large></a>
      </li>
    </ul>
